...
function ProductList({ onHomeClick }) {
    ...
    const totalCartCount = cartItems.reduce((total, item) => total + (item.quantity || 0), 0);
    ...
    const handleAddToCart = (plant) => {
        // Convert cost to a number before dispatching
        const costNumber = parseFloat(plant.cost.replace('$', ''));
        dispatch(addItem({ ...plant, cost: costNumber }));
                                    ...
                                    return (
                                        <div className='product-card' key={plantIndex}>
                                            ...
                                            <button
                                                ...
                                                disabled={isInCart}
                                                style={isInCart ? { backgroundColor: '#ccc', cursor: 'not-allowed' } : {}}
                                            >
